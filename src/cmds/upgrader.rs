    ...
    match method.trim() {
        "1" => {
            ...
            match method.trim() {
                ...
                "2" => run_shell_command("sudo rm /usr/bin/cmdcreate; git clone --branch cmdcreate --single-branch https://github.com/archlinux/aur.git cmdcreate; cd ~/cmdcreate; makepkg -si; rm -rf ~/cmdcreate", || {}),
                _ => error("Invalid selection.","")
            }
        }
        "2" => {
