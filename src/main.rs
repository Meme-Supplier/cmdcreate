...
fn display_usage() {
    ...
    let lines: Vec<String> = vec![
        ...
        format!("  {blue}name {yellow}<command> <new name>{reset}      Renames a command"),
        "\n  Update:".into(),
...
fn main() {
    ...
    match args[0].as_str() {
        ...
        "--get_offline_files" | "-g" => {
            ...
            println!("{}Files downloaded successfully.", COLORS.green);
        }
